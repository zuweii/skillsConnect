...
<template>
    ...
    <div v-else class="container mt-4">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a class="text-decoration-none text-secondary" href='#'>{{ classDetails.category }}</a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <h1 class="h2 mb-3">Payment for: {{ classDetails.title }}</h1>
          <div class="d-flex align-items-center mb-2">
            <span class="ms-3 text-colour">Available: {{ classDetails.max_capacity - classDetails.current_enrollment }}/{{
              classDetails.max_capacity }}</span>
          </div>
