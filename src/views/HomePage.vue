<template>
  ...
  <div v-else class="container-fluid px-4 mt-4">
    ...
    <div class="row mb-5">
      ...
      <div class="col-md-6 mb-4">
        <div class="card shadow-sm gradient-border">
          ...
          <div class="card-body p-0">
            <div
              v-if="upcomingClassesAsStudent.length === 0"
            ...
            <div v-else class="upcoming-list">
              <div
                v-for="classItem in upcomingClassesAsStudent"
                :key="classItem.id"
      ...
      <div class="col-md-6 mb-4">
        <div class="card shadow-sm gradient-border">
          ...
          <div class="card-body p-0">
            <div
              v-if="upcomingClassesAsTeacher.length === 0"
              class="p-4 upcoming-list d-flex align-items-center justify-content-center text-muted"
            >
            ...
            <div v-else class="upcoming-list">
              <div
                v-for="classItem in upcomingClassesAsTeacher"
                :key="classItem.id"
                class="upcoming-item p-3 border-bottom"
              >
                <div class="d-flex justify-content-between align-items-start">
    ...
    <div v-else class="row mb-5">
      <div
        v-for="classItem in nearbyClasses"
        :key="classItem.id"
        class="col-lg-3 col-md-4 col-sm-6 mb-4"
      >
        <div class="card shadow-sm h-100 hover-card">
